package io.jeletask.client.builder.composer.v2_8;

import io.jeletask.client.builder.composer.config.ConfigurationSupport;
...
import io.jeletask.client.builder.composer.config.statecalculator.DimmerStateCalculator;
import io.jeletask.client.builder.composer.config.statecalculator.HumidityStateCalculator;
import io.jeletask.client.builder.composer.config.statecalculator.LuxStateCalculator;
import io.jeletask.client.builder.composer.config.statecalculator.MotorStateCalculator;
import io.jeletask.client.builder.composer.config.statecalculator.OnOffToggleStateCalculator;
import io.jeletask.client.builder.composer.config.statecalculator.SensorStateCalculator;
import io.jeletask.client.builder.composer.config.statecalculator.StateCalculator;
import io.jeletask.client.builder.composer.config.statecalculator.TemperatureStateCalculator;
