...
| TELETASK_MQTT_RETAINED                           | Optional | false         | Indicates whether or not the messages should be retained by the broker. If you want your HA config to survive restarts, without restarting this service, you should change this to true                                                                                            |
