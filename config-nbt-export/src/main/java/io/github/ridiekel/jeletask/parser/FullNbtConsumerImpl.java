...
class FullNbtConsumerImpl implements NbtConsumer {
    /**
     * Logger responsible for logging and debugging statements.
     */
    private static final Logger LOG = LoggerFactory.getLogger(FullNbtConsumerImpl.class);

    private final NbtCentralUnit centralUnit;

    public FullNbtConsumerImpl() {
        this.centralUnit = new NbtCentralUnit();
    ...
    public NbtCentralUnit getCentralUnit() {
