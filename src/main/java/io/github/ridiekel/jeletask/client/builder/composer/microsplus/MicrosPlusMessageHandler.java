...
public class MicrosPlusMessageHandler extends MessageHandlerSupport {
    ...
    public EventMessage parseEvent(CentralUnit centralUnit, byte[] message) {
        ...
        State<?> state = ConfigurationSupport.getState(this, centralUnit, function, number, message, counter, StateCalculator::fromEvent);
    ...
    @Override
    public EventMessage createResponseEventMessageForTesting(CentralUnit centralUnit, Function function, OutputState outputState) {
