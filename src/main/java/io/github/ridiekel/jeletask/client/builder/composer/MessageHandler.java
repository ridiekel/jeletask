...
public interface MessageHandler {
    ...
    EventMessage createResponseEventMessageForTesting(CentralUnit centralUnit, Function function, OutputState outputState);

    record OutputState(int number, State<?> state) {
    }
}
