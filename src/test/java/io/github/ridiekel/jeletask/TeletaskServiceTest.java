...
class TeletaskServiceTest extends MockingTeletaskTestSupport {
    ...
    void inputShortPress() {
        ...
        mqtt().expect().input(10).lastStateMessage().toHave().state().inputClosed();
        ha().web().input(10)
        ...
        mqtt().expect().input(10).lastStateMessage(2).toHave().state().inputOpen();
        mqtt().expect().input(10).lastStateMessage(1).toHave().state().shortPress();
        mqtt().expect().input(10).lastStateMessage(0).toHave().state().inputOpen();
